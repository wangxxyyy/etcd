package org.yfcloud.etcd.business.etcdVersion.controller;
...
public class EtcdVersionController {

    private static final String url = "http://183.131.7.140:8700/etcd/version";

    @RequestMapping("/playVersionIndex")
    public String view() {
        return "etcd/version";
    }
