package org.yfcloud.etcd.business.etcdSelf.controller;
...
@Controller
@RequestMapping("/etcd")
public class EtcdSelfController {

    private static final String url = "http://183.131.7.140:8700/etcd/self";

    @RequestMapping("/playSelfIndex")
    public String  view() {
        return "etcd/self";
    }
