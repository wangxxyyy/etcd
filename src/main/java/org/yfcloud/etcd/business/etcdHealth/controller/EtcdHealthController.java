package org.yfcloud.etcd.business.etcdHealth.controller;
...
public class EtcdHealthController {
    ...
    private static final String url = "http://183.131.7.140:8700/etcd/health";

    @RequestMapping("/playHealthyIndex")
    public String view(){
        return "etcd/health";
    }
    ...
    @ResponseBody
    public List getHealthy(HttpServletRequest request){
        //调用健康状态接口
